namespace SnappFood_Employee_Evaluation.QC
{
    partial class RPT_QC_PENALTY
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "تاریخ تائید لاگ: از";
            // 
            // label22
            // 
            ...
            this.Text = "گزارش محاسبه جرایم کیفی کارشناسان مرکز تماس و پشتیبانی";
