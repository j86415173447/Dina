                ...
                if (dt2.Rows[i][3].ToString() != "-@zoodfood.com")
                {
                    ...
                    if (dt.Rows.Count != 0)
                    {
                        ...
                        mail.Body = "<table width = '100%'><tr><td align='right'><p dir='rtl'>" +
                                    ...
                                    "به این وسیله  ضمن تبریک سال جدید، مراتب سپاس خود را از تلاش و زحمات ارزشمند و صادقانه جنابعالی در زمینه پیشبرد اهداف دیجی کالا تقدیم می داریم." + "<br>" +
                                    "در سالی که گذشت شاهد فراز و نشیب های زیادی بودیم، بخش های جدیدی به دیجی کالا اضافه شد، دوستان زیادی از جمع ما جدا و اضافه شدند، در کنار یکدیگر رکوردهای فراوانی رو تجربه کردیم که هیچ کدام از این اتفاقات بدون حضور و کمک شما میسر نبود." + "<br>" +
                                    "امیدواریم همانطور که تاکنون " + "<font color='Red'><b>" + difference.ToString() + "</b></font>" + " روز از همکاری صادقانه شما گذشته است، در سال جدید نیز شاهد روحیه و انگیزه بالای شما برای پیشرفت خود و دیجی کالا باشیم." + "<br>" +
                        ...
                        mail.Body = mail.Body + "<br><br><font size='3px'>" + "با تشکر" + "<br>" + "تیم مدیریت دیجی کالا" + "<br><b>" + "سامانه متمرکز اطلاعات و پایش عملکرد پرسنل دیجی کالا - SFES" + "</b>" + "</font>" +
                    ...
                    else
                    {
                        ...
                        mail.Body = mail.Body +
                                    "<br><br><br><br><font size='3px'>" + "با تشکر" + "<br><br>" + "<b>" + "سامانه متمرکز اطلاعات و پایش عملکرد پرسنل دیجی کالا - SFES" + "</b>" + "</font>" +
                                    "<br><br><br><font color='Red'>" + "این ایمیل به صورت اتوماتیک ارسال شده است. لطفا به آن پاسخ ندهید." + "</font>" +
                                    "</font></p></td></tr></table>";
